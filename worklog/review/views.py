...
def timeline(req):
    ...
    if id == None:
        id = "0"
    return render(req, "review/timeline.html", locals())
...
def week_list(req):
    ...
    if id == None:
        id = "0"
    return render(req, "review/week_list.html", locals())
...
def table_list(req):
    ...
    if id == None:
        id = "0"
    return render(req, "review/table_list.html", locals())
...
def table_show(req):
    ...
    return JsonResponse({"info": datas, "status": result})
